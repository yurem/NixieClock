...
#define SENS_BME_ENABLE 1         //включить поддержку датчиков температуры BMPxxx и BMExxx(0 - датчик не используется(или используется на стороне esp) | 1 - используется датчик BMP085/BMP180 | 2 - используется датчик BMP280/BME280 | 3 - используются датчики BMP085/BMP180/BMP280/BME280)
