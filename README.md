...
Периферия:
    ...
    Сдвиговый регистр для управления анодами ламп и разделительными точками(неоновыми лампами) - по умолчанию подключается к D13/D11/D0.
...
Программно:
    ...
    3 режима работы секундных точек, 3 режима разделительных точек и доп.режимы для отображения состояния будильника.
